...
const About = ({ data }) => {
  const {
    file: {
      childImageSharp: { fluid: AboutMeImg }
    }
  } = data;
  return (
    <Layout>
      <div className="about">
        ...
        <div className="about__content">
          ...
          <br />
          <p>
            I am front end developer and aspiring UX/UI Designer that is
            currently looking for opportunities to collaborate with other
            partners and businesses to create cool innovative  web solutions.
          </p>
          ...
          <p>
            ...
            step at a time. Front End can be frustrating, it can be difficult,
            but delivering an the an amazing functional website that fulfills
            the needs of the user makes it all worth
          </p>
          <br />
          <p>
            I use the best technologies and techniques optimize the performance
            of websites. Utilising available tools and resources, I am able to
            reduce and streamline development time
          </p>
          <br />
          <div className="columns">
            ...
            <div className="column">
              <ul>
                ...
                <li>Mobile UI Development (Learning React Native)</li>
                <li>Learning Git</li>
              </ul>
            </div>
          </div>
...
export const pageQuery = graphql`
  query AboutImgQuery {
    file(relativePath: { eq: "about-me-header.jpg" }) {
      childImageSharp {
        fluid {
          base64
          aspectRatio
